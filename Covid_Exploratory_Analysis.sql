...
--Using a temp table to include the total_vaccinations column calculated in previous query
...
--Drop view included to run the query as many times possible without having to create another view name
